...
public class MongoDBCollectionCreation {
	public static void main(String[] args) throws ParseException {
		...
		// Step 3, create new collections and create index
		// If the collection does not exist, then the getCollection() method creates the
		// collection.
		...
		// If the collection does not exist, then the insertOne() method creates the
		// collection.
